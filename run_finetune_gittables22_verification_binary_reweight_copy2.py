...
for pos_ratio in [0.1]:
    for lr in [5e-4]:
        for task in ['gt-semtab22-dbpedia-all0']: # 'gt-semtab22-dbpedia-all0'
            comment = "mode@{}-context@{}-data@{}-test@{}-lr@{}-warmup@{}-dp@{}-norm@{}-pos@{}".format(veri_module, context, version, test_version, lr, warmup_ratio, dropout_prob, norm, pos_ratio)
            cmd = '''CUDA_VISIBLE_DEVICES={} python supcl_ft_verifier_binary.py --wandb True \
                        --shortcut_name {} --warmup_ratio {} --norm {} --eval_interval {} --data_version {} --test_version {} --veri_module {} --context {} --reweight True --task {} --pos_ratio {} --use_attention_mask True --max_length {} --lr {} --max_unlabeled {} --batch_size {} --epoch {} \
                        --dropout_prob {} --pretrained_ckpt_path "{}" --cl_tag {} --small_tag "{}" --comment "{}" {} {} {}'''.format(
                gpus, base_model, warmup_ratio, norm, eval_interval, version, test_version, veri_module, context, task,  pos_ratio, ml, lr, max_unlabeled, bs, n_epochs, dropout_prob,
