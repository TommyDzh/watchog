...
for max_num_col in [8]:
    for tau in [0.1]:
        for gate_version in ['v2.1', 'v3.1', 'v4.1', 'v5.1']:
            comment = "Repeat@{}-external@{}-pool@{}-context@{}-max_num_col@{}-target_num_col@{}-tau@{}-gate@{}".format(repeat, external_table_embedding, pool, ctype, max_num_col, target_num_col, tau, gate_version)
            for task in ['gt-semtab22-dbpedia-all0']:
                cmd = '''CUDA_VISIBLE_DEVICES={} python supcl_ft_colwise_selection_repeat.py --wandb True  \
                            --shortcut_name {} --task {} --repeat {} --external_table_embedding {} --max_length {} --max_num_col {} --context_encoding_type {} --pool_version {} --batch_size {} --use_token_type_ids {} --epoch {} \
                            --tau {} --target_num_col {}  --gate_version {} \
                            --dropout_prob {} --pretrained_ckpt_path "{}" --cl_tag {} --small_tag "{}" --comment "{}" {} {} {}'''.format(
                    gpus, base_model, task, repeat, external_table_embedding, ml, max_num_col, ctype, pool, bs, use_token_type_ids, n_epochs, 
                    tau, target_num_col, gate_version, 
