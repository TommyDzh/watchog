...
for max_num_col in [8]:
    for tau in [0.1]:
        ...
        for gate_version in ['v0.1']:
            gpus = '0'             
            comment = "external@{}-hard_inference@{}-ema_decay@{}-pool@{}-context@{}-max_num_col@{}-target_num_col@{}-tau@{}-gate@{}".format(external_table_embedding, hard_inference, ema_decay, pool, ctype, max_num_col, target_num_col, tau, gate_version)
            for task in ['sato0']:
