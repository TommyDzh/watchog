...
for warmup_ratio in [0.0]:
    for lr in [ 1e-4, 5e-4, 1e-3]:
        for task in ['gt-semtab22-dbpedia-all0']: # 'gt-semtab22-dbpedia-all0'
            comment = "CE-mode@{}-context@{}-lr@{}-warmup@{}-dp@{}-norm@{}-pos@{}".format(veri_module, context, lr, warmup_ratio, dropout_prob, norm, pos_ratio)
            cmd = '''CUDA_VISIBLE_DEVICES={} python supcl_ft_verifier_ce.py --wandb True \
                        --shortcut_name {} --warmup_ratio {} --norm {} --veri_module {} --context {} --task {} --pos_ratio {} --use_attention_mask True --max_length {} --lr {} --max_unlabeled {} --batch_size {} --epoch {} \
                        --dropout_prob {} --pretrained_ckpt_path "{}" --cl_tag {} --small_tag "{}" --comment "{}" {} {} {}'''.format(
                gpus, base_model, warmup_ratio, norm, veri_module, context, task,  pos_ratio, ml, lr, max_unlabeled, bs, n_epochs, dropout_prob,
