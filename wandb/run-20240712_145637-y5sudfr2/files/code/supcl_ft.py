...
if __name__ == "__main__":
    ...
    if accelerator.is_local_main_process:
        wandb.init(config=args,
            ...
            name=f"{args.model}_DS@{args.task}_scratch@{args.from_scratch}",
            group="TU",
            )
        wandb.log({
                f"tag_name": tag_name,
    ...
    eval_dict["ts_conf_mat"] = ts_conf_mat
    eval_dict["true_list"] = ts_true_list
    eval_dict["pred_list"] = ts_pred_list
